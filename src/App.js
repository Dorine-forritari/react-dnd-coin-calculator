      ...
      <div id='display'>
        ...
        <div id='pouch'>
          ...
          <div className='currencies'>
            <div className='row'>
              <div className='col-3 left__column'><Coin type='Copper' color='#b87333' /></div>
              <div className='col-3'>
                <div className='amount'>
                  <input type="number" min="0" max="10000" value={this.state.currentCopper} onChange={this.changeCopper} />
                </div>
              </div>
              <div className='col-3 column__newamount'>
            ...
            <div className='row'>
              <div className='col-3 left__column'><Coin type='Silver' color='silver' /></div>
              <div className='col-3'>
                <div className='amount'>
            ...
            <div className='row'>
              <div className='col-3 left__column'><Coin type='Electrum' color='#ffffbf' /></div>
              <div className='col-3'>
                <div className='amount'>
            ...
            <div className='row'>
              <div className='col-3 left__column'><Coin type='Gold' color='gold' /></div>
              <div className='col-3'>
                <div className='amount'>
            ...
            <div className='row'>
              <div className='col-3 left__column'><Coin type='Platinum' color='#e5e4e2'/></div>
              <div className='col-3'>
                <div className='amount'>
